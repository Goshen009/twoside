...
export default function ActionSelectorSheet({ isOpen, onClose, onSelectType }: ActionSelectorSheetProps) {
  return (
    ...
    >
      ...
      {/* Sheet Container: Edge-to-edge on mobile, max-w-md centered, rounded-t-3xl */}
      <div 
        ...
        <div className="space-y-2">
          ...
          <div className="grid grid-cols-3 gap-2.5">
            <button
              ...
              className="p-3.5 rounded-2xl bg-black/20 border border-white/5 flex flex-col items-center text-center gap-2.5 hover:border-red-500/40 hover:bg-red-500/5 transition-all group cursor-pointer"
            >
            ...
            <button
              ...
              className="p-3.5 rounded-2xl bg-black/20 border border-white/5 flex flex-col items-center text-center gap-2.5 hover:border-emerald-500/40 hover:bg-emerald-500/5 transition-all group cursor-pointer"
            >
            ...
            <button
              ...
              className="p-3.5 rounded-2xl bg-black/20 border border-white/5 flex flex-col items-center text-center gap-2.5 hover:border-sky-500/40 hover:bg-sky-500/5 transition-all group cursor-pointer"
            >
        ...
        <div className="space-y-2 pt-1">
          ...
          <div className="grid grid-cols-2 gap-2.5">
            <button
              ...
              className="p-3 rounded-xl bg-black/20 border border-white/5 flex items-center gap-3 hover:border-purple-500/40 hover:bg-purple-500/5 transition-all text-left group cursor-pointer"
            >
              <div className="w-8 h-8 rounded-xl bg-purple-500/10 border border-purple-500/20 flex items-center justify-center text-purple-400 shrink-0 group-hover:scale-105 transition-transform">
                <HandCoins className="w-4 h-4" />
              </div>
              <span className="text-xs font-medium text-zinc-300 group-hover:text-zinc-100">Loan Given</span>
            </button>

            <button
              onClick={() => onSelectType("loan_borrowed")}
              className="p-3 rounded-xl bg-black/20 border border-white/5 flex items-center gap-3 hover:border-amber-500/40 hover:bg-amber-500/5 transition-all text-left group cursor-pointer"
            >
              ...
              <span className="text-xs font-medium text-zinc-300 group-hover:text-zinc-100">Borrowing</span>
            </button>

            <button
              onClick={() => onSelectType("loan_repay_received")}
              className="p-3 rounded-xl bg-black/20 border border-white/5 flex items-center gap-3 hover:border-emerald-500/40 hover:bg-emerald-500/5 transition-all text-left group cursor-pointer"
            >
              ...
              <span className="text-xs font-medium text-zinc-300 group-hover:text-zinc-100">Repay In</span>
            </button>

            <button
              onClick={() => onSelectType("loan_repay_paid")}
              className="p-3 rounded-xl bg-black/20 border border-white/5 flex items-center gap-3 hover:border-rose-500/40 hover:bg-rose-500/5 transition-all text-left group cursor-pointer"
            >
              <div className="w-8 h-8 rounded-xl bg-rose-500/10 border border-rose-500/20 flex items-center justify-center text-rose-400 shrink-0 group-hover:scale-105 transition-transform">
                <CreditCard className="w-4 h-4" />
              </div>
              <span className="text-xs font-medium text-zinc-300 group-hover:text-zinc-100">Repay Out</span>
            </button>
          </div>
        </div>
