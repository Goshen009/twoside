...
export function ErrorToast({ message, onDismiss }: ErrorToastProps) {
  return (
    <motion.div
      ...
      className="absolute top-6 left-4 right-4 z-30 flex items-center justify-between gap-3 bg-surface/95 backdrop-blur-md border border-red-500/30 shadow-2xl shadow-red-950/40 px-4 py-3 rounded-2xl"
    >
