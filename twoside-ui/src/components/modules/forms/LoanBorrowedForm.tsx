...
interface LoanBorrowedFormProps {
  accounts: AccountBalance[];
  onClose: () => void;
}

const MOCK_COUNTERPARTIES = [
  { id: "1", name: "Bank / Microfinance" },
  { id: "2", name: "Sarah Williams" },
  { id: "3", name: "Family Loan" },
];

export default function LoanBorrowedForm({ accounts, onClose }: LoanBorrowedFormProps) {
    ...
    <form onSubmit={handleSubmit} className="space-y-4 relative">
      ...
      <div className="space-y-1.5">
        ...
        <div className="relative">
          ...
          <input
            type="text"
            placeholder="e.g., Short-term liquidity support..."
            value={description}
          ...
          >
            <div className="flex items-center gap-2 truncate">
              ...
              <span className="text-zinc-100 truncate">
                {selectedCounterparty ? selectedCounterparty.name : "Select lender"}
              </span>
            </div>
      ...
      <div className="space-y-2.5 pt-1">
        ...
        <div className="flex items-center justify-between px-3 py-2.5 rounded-xl bg-surface/60 border border-white/5 font-mono text-xs">
          <span className="text-muted text-[10px] uppercase tracking-wider">Total Borrowed</span>
        ...
        <div className="absolute inset-0 z-50 bg-surface/95 backdrop-blur-md rounded-3xl p-4 flex flex-col space-y-3 border border-white/10 animate-in fade-in zoom-in-95 duration-150">
          <div className="flex items-center justify-between gap-2 pb-1">
            <div className="relative flex-1">
              ...
              <input
                type="text"
                placeholder={activePicker === "account" ? "Search accounts..." : "Search lender..."}
                value={searchQuery}
