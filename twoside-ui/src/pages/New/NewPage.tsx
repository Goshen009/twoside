    ...
    <div className="min-h-screen bg-background flex flex-col">
      ...
      <main className="relative px-6 pb-6 flex-1 flex flex-col items-center z-20">
        ...
        <h1 className="text-lg font-bold text-foreground tracking-tight text-center mb-6">
          Ready to know where all your money went?
        </h1>
        ...
        >
          ...
          <button
            type="submit"
            className="w-full h-11 bg-primary hover:bg-primary-hover active:scale-[0.99] text-white font-bold text-xs rounded-full shadow-lg shadow-primary/20 flex items-center justify-center transition duration-150 ease-in-out cursor-pointer"
          >
